...
export default new Button('add-update-button')
	.setButton(new ButtonBuilder().setLabel('Add Upgrade/Downgrade').setStyle(ButtonStyle.Secondary))
				...
				.setComponents(
					...
					new ActionRowBuilder<ModalActionRowComponentBuilder>().addComponents(
						new TextInputBuilder()
							.setCustomId('changes')
							.setLabel('Changes')
							.setPlaceholder('Write out just the changes')
							.setStyle(TextInputStyle.Paragraph)
							.setMinLength(1)
							.setRequired(true)
					)
