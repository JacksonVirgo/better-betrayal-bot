...
data.addSubcommand((sub) =>
    sub
        ...
        .addIntegerOption((opt) =>
            opt
                .setName("luck")
                .setDescription("The luck value to view")
                .setRequired(true)
        )
...
data.addSubcommand((sub) =>
    sub
        ...
        .addIntegerOption((opt) =>
            opt
                .setName("items")
                .setDescription("Amount of items to have. Default 1")
                .setRequired(false)
        )
        .addIntegerOption((opt) =>
            opt
                .setName("aas")
                .setDescription("Amount of AAs to have. Default 1")
                .setRequired(false)
        )
        .addBooleanOption((opt) =>
            opt
...
data.addSubcommand((sub) =>
    sub
        .setName("item")
        .setDescription(
            "Get a random item from the luck table. For a pure random result, use /random item"
        )
        .addIntegerOption((opt) =>
            opt
                .setName("luck")
                .setDescription("The luck to use to calculate.")
                .setRequired(true)
        )
        .addBooleanOption((opt) =>
            opt
...
data.addSubcommand((sub) =>
    sub
        .setName("aa")
        .setDescription(
            "Get a random AA from the luck table. For a pure random result, use /random ability"
        )
        .addIntegerOption((opt) =>
            opt
                .setName("luck")
...
export async function calculateCarePackage(i: ChatInputCommandInteraction) {
    ...
    embed.setDescription(
        `Received ${itemCount} items: ${itemMessage}\nReceived ${aaCount} AAs: ${aaMessage}`
    );
