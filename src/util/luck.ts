...
export async function getRandomItem(luckTable?: LuckTable) {
	...
	if (rand < luckTable.common) {
		...
		itemRarity = 'RARE';
	} else if (rand < luckTable.common + luckTable.uncommon + luckTable.rare + luckTable.epic) {
		itemRarity = 'EPIC';
	} else if (rand < luckTable.common + luckTable.uncommon + luckTable.rare + luckTable.epic + luckTable.legendary) {
		itemRarity = 'LEGENDARY';
	} else if (rand < luckTable.common + luckTable.uncommon + luckTable.rare + luckTable.epic + luckTable.legendary + luckTable.mythical) {
		itemRarity = 'MYTHICAL';
	} else {
		itemRarity = 'MYTHICAL';
	}
