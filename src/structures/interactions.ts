...
export class Button extends Interaction {
    ...
    private func:
        | undefined
        | ((i: ButtonInteraction, cache?: string) => any | Promise<any>);
    ...
    public onExecute(
        func: (i: ButtonInteraction, cache?: string) => any | Promise<any>
    ) {
        this.func = func;
        return this;
    }
...
export class SelectMenu extends Interaction {
    ...
    private func:
        | undefined
        | ((i: AnySelectMenuInteraction, cache: string) => any | Promise<any>);
    constructor(customId: CustomID) {
        super(customId);
    ...
    public onExecute(
        func: (i: AnySelectMenuInteraction, cache: string) => any | Promise<any>
    ) {
        this.func = func;
        return this;
    }
...
export class Modal extends Interaction {
    ...
    public async getModal(cache?: string) {
        ...
        if (this.hydrateFunc)
            newModal.setComponents(await this.hydrateFunc(newModal, cache));
